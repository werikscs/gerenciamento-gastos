...
const CardEmpty = () => {
  return (
    <section className="empty-card">
      ...
      <svg width="562" height="89" viewBox="0 0 562 89" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="562" height="87.3519" rx="4" fill="#F8F9FA"/>
        <path d="M0 4C0 1.79087 1.80515 0 4.01429 0V0V87.3519V87.3519C1.80515 87.3519 0 85.561 0 83.3519V4Z" fill="#E9ECEF"/>
