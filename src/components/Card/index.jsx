...
const Card = ({description, cost, type, id, deleteCard}) => {

  const classColorBar = type.toLowerCase();

  return (
    <li className="card">

      <section className={classColorBar}></section>

      <section className="card__info">

        <section className="info__data">

          <span className="data__description">{description}</span>
          <span className="data__cost">R$ {cost}</span>

          <section className="data__trash-container" onClick={()=>deleteCard(id)}>
